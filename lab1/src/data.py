...
class CategoricalData:
    def __init__(self, data_id: int, use_binary_classify=True, use_stand=False, use_pca=False, pca_dim=0, seed=0,
                 ratio=0.9):
        ...
        self.ratio = ratio
        self.data_path = os.path.join(BASE_PATH, f"{data_id}")
...
class CategoricalDataset:
    def __init__(self, feature_path: str, target_path: str, seed=0):
